...
- (IBAction)proMod:(id)sender {
    ...
    _modText.text = @"Climate Change can be rather difficult to talk about. It's complex, huge, and can be very political. Luckily, we on the Climate Convos team have some guidance for you to follow during your conversations about and your approach towards climate change. Something to start you out with is that, no matter what, don't worry too much. Even though there's plenty of news, ongoing conversations, and changing legislature about climate change that can definitely get a little bit scary, it's not quite the end of the world. Make sure to always step back and don't let the severity of the situation stress you. It's always important to talk about climate change optimistically, and in terms of finding soltions. Many, when approaching the topic, can find themselves worrying and overly stressed, speaking about the end of days and so forth. Also, it is often such worries aren't appropriately educated or researched; the best thing that we can do to combat this is to educate ourselves, which is what you're doing right now! We're here to tell you that, even if it were the 'end of days', speaking so negatively isn't going to get anything done. To hold proactive conversations, stay positive, and discuss real-life action that can be taken. The importance is understanding the difference between urgency and agency. Urgency is the stress and motivation which come with realizing the severity of the problem, whereas agency is the actual action which can be taken in order to help mend the issue itself. Agency is far more important. The major difference to distinguish in this ongoing conversation to combat climate change is that: it's a conversation. It's not an argument, or a debate. And if it ever turns into one, then time to talk about solutions and being proactive is lost. Arguing with an uncle at Thanksgiving dinner gets us, and our planet, nowhere. Instead of this argument, throwing aggressive opinions around, think about instead holding a friendly climate conversation, backed up with facts, and education. And you can do that by starting here.";
