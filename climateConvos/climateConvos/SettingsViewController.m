...
- (IBAction)seattleButton:(id)sender {
    ...
    [[NSUserDefaults standardUserDefaults] setObject:valueToSave forKey:@"location"];
     self.seattleButton.backgroundColor=[UIColor colorWithRed:170/255.0 green:170/255.0 blue:170/255.0 alpha:1.0];
    self.seattleButton.titleLabel.textColor=[UIColor whiteColor];
